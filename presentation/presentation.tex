...
\begin{frame}{Efficient Resource Utilization (ERU)}
  ...
  % @TODO Think about from Google's perspective.
\end{frame}
...
\begin{frame}{Balancing ERU and QOS}
  ...
  % @TODO Talk about varying resources. Real-world instances of flash crowds.
\end{frame}
...
% @TODO Provide a background on the space.
...
\begin{frame}{Details of Kubernetes}
  ...
  \begin{itemize}
    \item Pod
      ...
      % @TODO Explain containerization - and why useful.
...
\begin{frame}{Current State of Auto-scaling in Kubernetes}
  ...
  % @TODO Should I include the algorithm? Try it out.
...
% @TODO Should I be including the new algorithm? Yes.
